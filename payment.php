<html>
    ...
    <body>
        ...
        <p class="para">
            Created For The Sparks Foundation Internship by Pratyush Tripathi 
        </p> 
        ...
        <div class="container">
            <div class="row">
                <div class="donatebox">
                    ...
                    <h2>Your Small Step Can Make Someone Smile</h2>
                    <form><script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_G3NS8o3nbnKiVM"> </script> </form>
                </div>
            </div>
        </div>
